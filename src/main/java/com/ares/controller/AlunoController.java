...
public class AlunoController {
    ...
    @GetMapping
    @Operation (summary = "Listar todos os alunos", description = "Retorna uma lista complesta com todos os alunos cadastrados")
    public List<Aluno> listarTodos() {
        return alunoService.listarTodos();
    }

    @PostMapping
    @Operation (summary = "Cadastrar novos alunos", description = "Cadastrar um aluno na academia")
    ...
    @PutMapping("/{id}")
    @Operation (summary = "Atualizar alunos", description = "Atualiza todos os dados de um aluno existente")
    ...
    @DeleteMapping("/{id}")
    @Operation (summary = "Deletar aluno", description = "Deletar aluno existente")
    ...
    @GetMapping("/{id}")
    @Operation (summary = "Buscar um aluno por id", description = "Busca usuário existente por id")
    public ResponseEntity<Aluno> buscarPorId(@PathVariable Long id){
        return ResponseEntity.ok(alunoService.buscarPorId(id));
    }

    @GetMapping("/matricula/{id}")
    @Operation (summary = "Verificar status da matricula", description = "Verifica se a matricula está ativa")
